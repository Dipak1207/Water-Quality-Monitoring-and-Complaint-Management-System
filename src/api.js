...
// Feedback module
export const getAllFeedback = () => axios.get(`${API_URL}/api/feedback/getAll`);
export const createFeedback = (feedback) => axios.post(`${API_URL}/api/feedback/add`, feedback);
export const deleteFeedback = (id) => axios.delete(`${API_URL}/api/feedback/${id}`);

// Water Quality Test Report module
export const getAllWaterTestReports = () => axios.get(`${API_URL}/api/water-tests/getAll`);
export const createWaterTestReport = (report) => axios.post(`${API_URL}/api/water-tests/add`, report);
export const deleteWaterTestReport = (id) => axios.delete(`${API_URL}/api/water-tests/${id}`);